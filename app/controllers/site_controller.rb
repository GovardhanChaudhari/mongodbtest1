class SiteController < ApplicationController
	...
	def search
		...
		search_hash = {:college_id => params[:college_id],:branch=> params[:branch_id],:round => params[:round],:caste=>params[:caste]}
		...
		if(@branch)
			...
			@cutoffs = @branch.cutoffs.where(:caste => search_hash[:caste],:round => search_hash[:round])
		else
