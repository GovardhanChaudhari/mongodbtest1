...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { area: @college.area, city: @college.city, code: @college.code, name: @college.name }
    end
  ...
  test "should update college" do
    put :update, id: @college, college: { area: @college.area, city: @college.city, code: @college.code, name: @college.name }
    assert_redirected_to college_path(assigns(:college))
  end
