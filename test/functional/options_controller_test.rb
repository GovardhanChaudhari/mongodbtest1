...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { attempt_id: @option.attempt_id, branch: @option.branch, college_name: @option.college_name }
    end
  ...
  test "should update option" do
    put :update, id: @option, option: { attempt_id: @option.attempt_id, branch: @option.branch, college_name: @option.college_name }
    assert_redirected_to option_path(assigns(:option))
  end
